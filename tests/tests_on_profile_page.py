...
@pytest.mark.parametrize("custom_input,expected_respond", [
    ...
    (("123", "M", "2020", valid_email_1, valid_password_1, valid_password_2, ''), "Информация о пользователе НЕ сохранена!"),
    (("SeleniumTest", "M", "1900", valid_email_1, valid_password_1, valid_password_1, ''), "Информация о пользователе успешно сохранена!"),
